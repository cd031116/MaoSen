...
import gp.ms.com.chat.RobotUser;
import gp.ms.com.chat.domian.EmojiconExampleGroupData;
import gp.ms.com.chat.ui.ContextMenuActivity;
import gp.ms.com.chat.ui.ForwardMessageActivity;
import gp.ms.com.chat.ui.GroupDetailsActivity;
import gp.ms.com.chat.ui.UserProfileActivity;
import gp.ms.com.chat.ui.VideoCallActivity;
import gp.ms.com.chat.ui.VoiceCallActivity;
import gp.ms.com.chat.widget.ChatRowConferenceInvitePresenter;
import gp.ms.com.chat.widget.ChatRowLivePresenter;
...
public class ChatFragment extends EaseChatFragment implements EaseChatFragmentHelper {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return super.onCreateView(inflater, container, savedInstanceState,
                true && (chatType != EaseConstant.CHATTYPE_CHATROOM));
    }
...
//                                putExtra("groupId", toChatUsername), REQUEST_CODE_SELECT_AT_USER);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(resultCode == Activity.RESULT_OK){
            switch (requestCode) {
            case PictureConfig.CHOOSE_VIDEO: //send the video
                ...
                for (LocalMedia media : selectList) {
                    ...
                    try {
                        ...
                        fos.close();
                        sendVideoMessage(media.getPath(), file.getAbsolutePath(), (int) media.getDuration());
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
...
//                        .videoMinSecond(10)
                ...
                .forResult(PictureConfig.CHOOSE_VIDEO);//结果回调onActivityResult code
