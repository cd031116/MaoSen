...
import gp.ms.com.http.cookie.CookieJarImpl;
import gp.ms.com.http.cookie.store.CookieStore;
import gp.ms.com.http.http.HttpClient;
import gp.ms.com.http.http.SSLUtils;
import gp.ms.com.http.interceptor.CommonInterceptor;
import gp.ms.com.http.interceptor.HeaderInterceptor;
import gp.ms.com.http.interceptor.NetCacheInterceptor;
import gp.ms.com.http.interceptor.NoNetCacheInterceptor;
import gp.ms.com.http.interceptor.RxHttpLogger;
...
public class OkHttpConfig {
    ...
    private static final long defaultCacheSize = 1024 * 1024 * 50;
    ...
    public static class Builder {
        ...
        public OkHttpClient build() {
            ...
            okHttpClient = okHttpClientBuilder.retryOnConnectionFailure(false).build();
            return okHttpClient;
        }
...
//         */
        private void setCommonConfig() {
                okHttpClientBuilder.addInterceptor(new CommonInterceptor());
        }
