...
//    private BaseAnimatorSet mDismissAnim;
    ...
    private void setDialogTheme() {
        ...
        getWindow().setBackgroundDrawable(new ColorDrawable(Color.parseColor("#30000000")));// android:windowBackground
...
//        mMaxHeight = mDisplayMetrics.heightPixels - StatusBarUtils.getHeight(mContext);
        ...
        if (mIsPopupStyle) {
            setContentView(mLlTop, new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
