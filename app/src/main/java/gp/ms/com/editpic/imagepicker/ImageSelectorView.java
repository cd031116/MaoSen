package gp.ms.com.editpic.imagepicker;
...
public class ImageSelectorView extends FrameLayout implements View.OnClickListener {
                ...
                switch (msg.what) {
                    case WHAT_REFRESH_PATH_LIST:
                        if (mAdapter == null) {
                            ...
                            mBtnEnter.setText(getContext().getString(R.string.ok) + "(" + mAdapter.getSelectedSet().size() + ")");
    ...
    private class ItemClickListener implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            mBtnEnter.setText(getResources().getString(R.string.ok) + "(" + mAdapter.getSelectedSet().size() + ")");
        }
    }
