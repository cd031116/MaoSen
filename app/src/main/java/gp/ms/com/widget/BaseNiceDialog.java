...
public abstract class BaseNiceDialog extends DialogFragment {
    ...
    private void initParams() {
        ...
        if (window != null) {
            ...
            lp.width = DpUtils.getScreenWidth(getContext()) - 2 * DpUtils.dp2px(getContext(), margin);
            lp.height = DpUtils.getScreenHeight(getContext()) - 4* DpUtils.dp2px(getContext(), margin);
            //设置dialog进入、退出的动画
    ...
    public BaseNiceDialog setIsShangKe(boolean isShangke,String number) {
    ...
    public BaseNiceDialog setpName(String pName) {
        this.pName = pName;
        return this;
    }
