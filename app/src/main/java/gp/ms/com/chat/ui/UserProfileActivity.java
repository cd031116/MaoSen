 ...
 * 个人资料
 * */
public class UserProfileActivity extends ChatBaseActivity implements View.OnClickListener {
...
//        });
    ...
    private void updateRemoteNick(final String nickName) {
        ...
        new Thread(new Runnable() {
            ...
            @Override
            public void run() {
                ChatHelper.getInstance().getUserProfileManager().updateCurrentUserNickName(nickName);
